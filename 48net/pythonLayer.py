...
class BatchLoader(object):
    def __init__(self,pos_list, neg_list, part_list, landmark_list, net_side, pos_root, neg_root, part_root, landmark_root):
        ...
        if imdb_exit:
            fid = open('{}/positive.imdb'.format(net_side),'r')
        ...
        if imdb_exit:
            fid = open('{}/negative.imdb'.format(net_side),'r')
        ...
        if imdb_exit:
            fid = open('{}/part.imdb'.format(net_side),'r')
        ...
        if imdb_exit:
            fid = open('{}/landmark.imdb'.format(net_side),'r')
